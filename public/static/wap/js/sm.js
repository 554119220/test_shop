...
+function ($) {
    ...
    $.prompt = function (text, title, callbackOk, callbackCancel, type) {
        if (typeof title === 'function') {
            callbackCancel = arguments[2];
            callbackOk = arguments[1];
            title = undefined;
        ...
        return $.modal({
            text: text || '',
            title: typeof title === 'undefined' ? defaults.modalTitle : title,
            afterText: '<input type="'+type+'" class="modal-text-input">',
            buttons: [
                {
    ...
    $.modalPayPassword = function (text, title, callbackOk, callbackCancel) {
        if (typeof title === 'function') {
            callbackCancel = arguments[2];
            callbackOk = arguments[1];
            title = undefined;
        ...
        return $.modal({
            text: text || '',
            title: typeof title === 'undefined' ? defaults.modalTitle : title,
            afterText: '<input type="password" name="modal-password" placeholder="' + defaults.modalPayPasswordPlaceholder + '" class="modal-text-input">',
            buttons: [
                {
                    text: defaults.modalButtonCancel
                },
    ...
    var defaults =  $.modal.prototype.defaults  = {
        ...
        modalPasswordPlaceholder : '请输入登陆密码',
        modalUsernamePlaceholder : '请输入用户名或手机号码',
        modalPayPasswordPlaceholder : '请输入安全密码'
    };
}(Zepto);
