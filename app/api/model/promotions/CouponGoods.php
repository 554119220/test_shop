 ...
 */
class CouponGoods extends \think\Model
{
    protected $pk = 'coupon_goods_id';
    protected $append = [];
    protected $resultSetType = 'array';
    protected $autoWriteTimestamp = true;
    protected $createTime = 'coupon_goods_create_time';
    protected $updateTime = 'coupon_goods_update_time';
