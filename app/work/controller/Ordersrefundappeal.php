...
class Ordersrefundappeal extends Commonmodules
{
    public function _initialize()
    {
        parent::_initialize();
        $this->formtpl_id   = 680;  //表单模板ID
        $this->module_name  = '退款申诉';   //模块名称
        $this->initForm();
    ...
    public function index(){
        $params = [
                'where' => ['refund_state' => ['in', [State::STATE_REFUNDS_BUYER_APPEAL, State::STATE_REFUNDS_SELLER_APPEAL]]],
                'page'  => input('p', 1),
                'relation'  => 'refund',
...
//        dump($res);
        ...
        $btns   = 'return "<div data-id=\'$val[refund_logs_id]\' data-refundid=\'$val[orders_refund_id]\' class=\'btn red btn-outline btn-block\' onclick=\'extra_tr_view($(this))\'>详情</div>";';
        $btns   = [$btns];
